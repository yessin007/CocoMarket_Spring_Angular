...
export declare class GalleryThumbsComponent implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<GalleryThumbsComponent, "gallery-thumbs", never, { "state": "state"; "config": "config"; }, { "action": "action"; "thumbClick": "thumbClick"; "error": "error"; }, never, never>;
}
