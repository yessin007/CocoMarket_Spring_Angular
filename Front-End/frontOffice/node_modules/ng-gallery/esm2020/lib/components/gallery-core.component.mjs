...
import * as i1 from "./gallery-thumbs.component";
import * as i2 from "./gallery-slider.component";
import * as i3 from "./gallery-nav.component";
import * as i4 from "./gallery-dots.component";
...
GalleryCoreComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.2.3", type: GalleryCoreComponent, selector: "gallery-core", inputs: { state: "state", config: "config" }, outputs: { action: "action", itemClick: "itemClick", thumbClick: "thumbClick", error: "error" }, host: { properties: { "attr.thumbPosition": "this.thumbPosition", "attr.slidingDirection": "this.slidingDirection", "attr.disableThumb": "this.disableThumb", "attr.imageSize": "this.imageSize", "attr.dotsPosition": "this.dotsPosition", "attr.counterPosition": "this.counterPosition" } }, ngImport: i0, template: `
  ...
  `, isInline: true, components: [{ type: i1.GalleryThumbsComponent, selector: "gallery-thumbs", inputs: ["state", "config"], outputs: ["action", "thumbClick", "error"] }, { type: i2.GallerySliderComponent, selector: "gallery-slider", inputs: ["state", "config"], outputs: ["action", "itemClick", "error"] }, { type: i3.GalleryNavComponent, selector: "gallery-nav", inputs: ["state", "config"], outputs: ["action"] }, { type: i4.GalleryDotsComponent, selector: "gallery-dots", inputs: ["state", "config"], outputs: ["action"] }, { type: i5.GalleryCounterComponent, selector: "gallery-counter", inputs: ["state"] }], directives: [{ type: i6.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
