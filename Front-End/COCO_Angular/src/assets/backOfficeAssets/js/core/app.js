...
(function (window, document, $) {
  ...
  $(window).on('load', function () {
    ...
    if ($(".menuSideBar-hide-on-scroll").length > 0) {
      $(".menuSideBar-hide-on-scroll.fixed-top").headroom({
        "offset": 205,
        "tolerance": 5,
        "classes": {
      ...
      $(".menuSideBar-hide-on-scroll.fixed-bottom").headroom({
        "offset": 205,
        "tolerance": 5,
        "classes": {
          // when element is initialised
  ...
  $(document).on('click', '.menu-toggle, .modern-nav-toggle', function (e) {
    ...
    if ($('.vertical-overlay-menu .menuSideBar-with-menu .menuSideBar-container .menuSideBar-collapse').hasClass('show')) {
      $('.vertical-overlay-menu .menuSideBar-with-menu .menuSideBar-container .menuSideBar-collapse').removeClass('show');
    }

    return false;
  });

  $(document).on('click', '.open-menuSideBar-container', function (e) {
  ...
  $(window).resize(function () {
    ...
    if ($(window).width() > 768) {
      ...
      $(".search-input input").blur()
      $(".search-input").removeClass("open")
      if ($(".header-menuSideBar").find(".search-list.show")) {
        $(".header-menuSideBar").find(".search-list.show").removeClass("show")
      }
      $(".app-content").removeClass("show-overlay")
    }
  });
  ...
  $(".dropdown-language .dropdown-item").on("click", function () {
    ...
    i18next.changeLanguage(currentLanguage, function (err, t) {
      $(".main-menu , .menuSideBar-horizontal").localize();
    });
  })
