...
(function (window, document, $) {
  ...
  $.app.menu = {
    ...
    change: function (defMenu) {
      ...
      // Added data attribute brand-center for menuSideBar-brand-center
      // TODO:AJ: Shift this feature in PUG.
      if ($(".header-menuSideBar").hasClass("navbar-brand-center")) {
        $(".header-menuSideBar").attr("data-nav", "brand-center");
      }
      if (currentBreakpoint.name == "sm" || currentBreakpoint.name == "xs") {
        $(".header-menuSideBar[data-nav=brand-center]").removeClass(
          "navbar-brand-center"
        );
      } else {
        $(".header-menuSideBar[data-nav=brand-center]").addClass(
          "navbar-brand-center"
        );
      }
      ...
      if (menuType == "horizontal-menu") {
        if (currentBreakpoint.name == "xl") {
          if ($(".menuSideBar-fixed").length) {
            $(".menuSideBar-fixed").sticky();
          }
        } else {
        ...
        this.transit(
          ...
          function () {
            ...
            if (
              ...
              $(".main-menu-content").css(
                "height",
                $(window).height() - $(".header-menuSideBar").height()
              );
              if (!$(".main-menu-content").hasClass("ps")) {
                this.manualScroller.enable();
              }
    ...
    changeMenu: function (screen) {
      ...
      if (screen === "xl") {
        // Change body classes
        $body
          .removeClass("vertical-layout vertical-overlay-menu fixed-menuSideBar")
          .addClass($body.data("menu"));

        // Remove menuSideBar-fix-top class on large screens
        $("nav.header-menuSideBar").removeClass("fixed-top");
        ...
        $body
          ...
          .addClass("vertical-layout vertical-overlay-menu fixed-menuSideBar");

        // Add menuSideBar-fix-top class on small screens
        $("nav.header-menuSideBar").addClass("fixed-top");
  ...
  $.app.nav = {
    ...
    bind_events: function () {
      ...
      $(".menuSideBar-header, .main-menu")
        .on("mouseenter", modernMenuExpand)
        .on("mouseleave", modernMenuCollapse);

      function modernMenuExpand() {
        if ($body.data("menu") == "vertical-menu-modern") {
          $(".main-menu, .menuSideBar-header").addClass("expanded");
          if ($body.hasClass("menu-collapsed")) {
        ...
        if (
          ...
          setTimeout(function () {
            if (
              ...
              $(".menuSideBar-header:hover").length === 0
            ) {
              $(".main-menu, .menuSideBar-header").removeClass("expanded");
    ...
    adjustSubmenu: function ($menuItem) {
      ...
      winHeight = $window.height() - $(".header-menuSideBar").height();
      borderWidth = 0;
